...
<template>
  <header
    class="h-18 sticky top-0 z-50 backdrop-blur-md border-b border-dashed border-slate-800/20 dark:border-white/20"
  >
    <div
      class="flex items-center h-full px-1 mx-auto max-w-7xl sm:px-3 lg:px-6"
    >
      <button
